...
//  Flickr Client App
//
//  Created by SAFA HELVACI on 30.09.2022.
//
...
class RecentPhotosTableViewController: UITableViewController, UISearchResultsUpdating {
    ...
    private func fetchRecentPhotos(){
        guard let url = URL(string: "https://www.flickr.com/services/rest/?method=flickr.photos.getRecent&api_key=55ca5e48139378affdb082ce681cff84&format=json&nojsoncallback=1&extras=description,owner_name,icon_server,url_n,url_z") else { return }
    ...
    private func searchPhotos(with text: String){
        guard let url = URL(string: "https://www.flickr.com/services/rest/?method=flickr.photos.search&api_key=55ca5e48139378affdb082ce681cff84&text=\(text)&format=json&nojsoncallback=1&extras=description,owner_name,icon_server,url_n,url_z") else { return }
